            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="breadcrumb-holder">
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active"><a href="?view=votante">Inscripciones</a></li>
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-content">
                            ...
                            if(count($Votante)>0){ 
                                    if(!empty($var)){
                                    $Votante = VotanteData::GetByNoDoc($var);
                                        ?>
                                    <form class="form-horizontal " method="POST" id="nuevoanexovotante" action="?view=addanexovotante" role="form" enctype='multipart/form-data'>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div id="bloquenecesario">
                                                    <div class="form-group">
                                                        <br/>
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" name="idVotante" value="<?php echo $Votante->id;?>" class="form-control" id="idVotante" 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" name="noDocumento" value="<?php echo $Votante->noDocumento;?>" class="form-control" id="noDocumento" 
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" name="nombre" value="<?php echo $Votante->nombre;?>" class="form-control" id="nombre" 
            ...
            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <h3><i class="fa fa-address-card"></i> Buscar votante </h3>
                        </div>    
                        <div class="card-body">
                            <form class="form-horizontal " method="POST" id="buscar" action="?view=newanexovotante" role="form">
                                <div class="form-group">
                                ...
                                <div class="card-footer text-center">
                                    <button typo="submit" name="buscarvotante" id="buscarvotante" class="btn btn-info btn-fill btn-wd">Buscar</button>
                                </div>
                            </form>
                        </div>
                    </div>

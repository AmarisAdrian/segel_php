<?php
class EstadoUsuarioData{
    public static $Tablename = "estado_usuario";
    ...
    public function Update(){
        $sql = "update ".self::$Tablename." set \"$this->nombre\" where id=$this->id";
        $query = Executor::doit($sql);
        return $query[1];
    }
    ...
    public static function GetById($id){
       ...
       $query = executor::doit($sql);
       return Model::one($query[0],new EstadoUsuarioData());
    }
     /**
	*   Busqueda, paginacion y ordenamiento
	*   @method EstadoUsuarioData::Search
	...
	*/
    public static function Search($q = "", $limit = 8,  $offset = 0, $sort = "nombre", $order = "ASC" ){
        ...
        $query = executor::doit($sql);
        //var_dump($query);die;
        return Model::many($query[0],new EstadoUsuarioData());
    }
